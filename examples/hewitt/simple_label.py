...
def create_sim_space(
    ...
    if visualize:
        ...
        eps_fg, eps_bg = get_fg_and_bg(context.get_object(simspace), label=1070) #edit here
...
def create_objective(
    ...
    monitor_list = []
    for wlen, overlap, label in zip([1070, 1070, 1070], [upper, lower, wg_out], [1069, 1070, 1071]):
