...
@optplan.register_node(optplan.AnnulusOverlap)
class AnnulusOverlap:
    def __init__(self,
                 params: optplan.AnnulusOverlap,
                 work: workspace.Workspace = None) -> None:
        """Creates a new annulus overlap.

        Args:
            params: Annulus mode parameters.
            work: Unused.
        """
        self._params = params
